-- =============================================
-- Welmy — 002: RAG schema (sem ACL por categoria/equipe)
...
-- - Tabelas: wl_document_metadata, wl_document_rows, wl_documents
...
ALTER TABLE wl_document_metadata ADD COLUMN IF NOT EXISTS session_id TEXT;
